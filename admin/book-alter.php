<?php
    ...
    $old_name = $_POST['name'] ?? "";
    $book = Product::select_product($old_name, $connection);
    $data = $book['data'][0];
...
<body>
    ...
    <form action="/process/process-book-alter.php" method="post">
        ...
        <input type="hidden" name="old_price" value="<?= $data['valor'] ?>">
        <input type="hidden" name="old_describ" value="<?= $data['descricao'] ?>">
        <input type="hidden" name="old_stock" value="<?= $data['qtd'] ?>">
