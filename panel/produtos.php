	...
	<main>
		...
		<section id="main-content">
			<section class="flex-title" id="title">
				<section>
					<h1 class="no-mar">Painel dos Produtos</h1>	
				</section>
				<section>
					<div>
			...
			<section>
				<section class="form-area">
					<section>
						<h1><i class="fa-solid fa-box-open"></i> Adicionar Produto:</h1>
					</section>					
					<form class="std-form">
						...
						<div class="form-session">
							<span>
								<textarea class="std-textarea" name="descri">
						...
						<div class="form-session">
							<span>
								<span class="input-body">
									<input type="number" name="paginas" placeholder="Qtd. Páginas">
								</span>
							</span>
							<span>
								<span class="input-body">
	...
	<section class="pop-up-back hidden" id="pop-up-edit">
		<section class="pop-up-area">
			<section class="form-area">
				<form class="">
					<section>
						<h1><i class="fa-solid fa-box-open"></i> Alterar:</h1>
					</section>					
					<form class="std-form">
						<div class="form-session">
